...
| `standards/` | Portable rules, reusable on any project — engineering, testing, documentation. |
| `project/` | BalloonHunter's bindings: layers, source layout, pure rules, prohibitions, tooling. |
